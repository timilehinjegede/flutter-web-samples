...
import 'package:web_samples/game_streaming/data/data.dart';
import 'package:web_samples/game_streaming/widgets/widgets.dart';
import 'package:web_samples/screen_util.dart';
import 'package:web_samples/utils/theme.dart';

class GameStreamingHomeScreen extends StatelessWidget {
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                      ...
                      child: CircleAvatar(
                        radius: 25,
                        backgroundImage: AssetImage('assets/images/game_streaming/avatar.jpeg'),
                      ),
                    ),
                  ],
                ),
